...
import { handleSupabaseLoginError, handleSupabaseGoogleError } from "@/lib/login-error-switch"
...
export default function LoginForm() {
  ...
  // Handle OAuth callback errors passed via URL parameters
  useEffect(() => {
  ...
  // Note: Redirect logic moved to auth context (on SIGNED_IN events only)
  // This prevents auto-redirect when user has cached session
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (error) {
        const errorMessage = handleSupabaseLoginError(error)
      ...
      if (data.user) {
        setIsSubmitting(false)
        setIsSuccess(true)
        // Redirect to avatar page after successful login
        setTimeout(() => {
          navigate('/avatar')
    ...
    <div className="w-full">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="mt-2 text-sm text-[var(--muted-foreground)]">
          Continue your car buying journey
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link to="/auth/forgot-password" className="text-xs text-[var(--toyota-red)] hover:text-[var(--toyota-red)]/80 hover:underline">
              Forgot password?
            </Link>
          </div>
          <div className="relative">
        ...
        <div className="text-sm text-center text-[var(--muted-foreground)]">
          ...
          <Link to="/auth/signup" className="text-[var(--toyota-red)] hover:text-[var(--toyota-red)]/80 hover:underline">
            Sign up
          </Link>
        </div>
      </form>
